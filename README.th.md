...
### 📹 วิดีโอสาธิต (28 วินาที)

> *เมื่อพระสงฆ์พยายามใช้เงินผิดศีล Sila Protocol ระงับธุรกรรมก่อนเงินจะเคลื่อนย้าย
> เมื่อพระสงฆ์จ่ายค่าไฟฟ้าให้วัด Sila อนุมัติบนบล็อกเชน — บุญที่ตรวจสอบได้*

<video src="https://github.com/Anon5th/Sila/raw/main/docs/demo.mp4" controls muted playsinline width="100%"></video>

หากเบราว์เซอร์ของคุณไม่แสดงผลวิดีโอด้านบน:
**[▶︎ ดู / ดาวน์โหลด `demo.mp4`](./docs/demo.mp4?raw=1)** *(555 KB, H.264 1280×720)*
